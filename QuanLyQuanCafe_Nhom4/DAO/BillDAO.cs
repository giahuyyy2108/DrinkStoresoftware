...
namespace QuanLyQuanCafe_Nhom4.DAO
{
    public class BillDAO
    {
        ...
        public void DeleteBillIByTableID(int id)
        {
       ...
       public void InsertBill(int id)
        ...
        public DataTable GetBillListByMonth( DateTime checkOut)
        {
            return DataProvider.Instance.ExecuteQuery("exec USP_GetListBillByMonth @checkOut", new object[] { checkOut });
        }
